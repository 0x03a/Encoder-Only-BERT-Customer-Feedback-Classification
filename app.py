...
def load_model():
    try:
        model_path = '/home/inshal/Downloads/sentiment/bert_sentiment_model'
...
with st.sidebar:
    ...
    page = st.radio(
        "Select Page:",
        ["🔮 Predict Sentiment", "📊 Model Evaluation", "📁 Batch Prediction"]
    )
...
if page == "🔮 Predict Sentiment":
    ...
    with col2:
        ...
        examples = {
            "Positive 1": "This product is amazing! I love it so much.",
            "Negative 1": "Terrible experience, would not recommend.",
            "Positive 2": "Best purchase I've made this year!",
            "Negative 2": "Complete waste of money. Very disappointed.",
            "Neutral": "The quality is okay but nothing special."
        }
